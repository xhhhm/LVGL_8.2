...
//电阻屏芯片连接引脚	   
#define PEN  				HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_1)  	//T_PEN
#define DOUT 				HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_2)   	//T_MISO
#define TDIN(X) 		HAL_GPIO_WritePin(GPIOF,GPIO_PIN_11,X)  	//T_MOSI
#define TCLK(X) 		HAL_GPIO_WritePin(GPIOB,GPIO_PIN_0,X)  	//T_SCK
#define TCS(X)  		HAL_GPIO_WritePin(GPIOC,GPIO_PIN_13,X)  	//T_CS  
