...
//IO操作函数	 
#define CT_IIC_SCL(X)    HAL_GPIO_WritePin(GPIOB,GPIO_PIN_0,X) 	//SCL
#define CT_IIC_SDA(X)    HAL_GPIO_WritePin(GPIOF,GPIO_PIN_11,X) //SDA	 
#define CT_READ_SDA   	 HAL_GPIO_ReadPin(GPIOF,GPIO_PIN_11)  //输入SDA 
